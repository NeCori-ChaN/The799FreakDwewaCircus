# TODO: Translation updated at 2025-11-26 23:31
...
translate japanese strings:
    ...
    new "アクセシビリティメニュー。上下の矢印キーで移動し、Enterキーでボタンやスライダーをアクティブにします。"
    ...
    new "タッチスクリーンを使用する場合、自己音声サポートは制限されます。"
    ...
    new "[text] ディレクトリを開きます。"

    # renpy/common/00director.rpy:712
    old "The interactive director is not enabled here."
    new "ここではインタラクティブ ディレクターは有効になっていません。"
    ...
    new "クリックすると属性が切り替わり、右クリックすると反の属性が切り替わります。"
    ...
    new "クリックして変換を設定し、右クリックして変換リストに追加します。"

    # renpy/common/00director.rpy:1777
    old "Customize director.transforms to add more transforms."
    new "director.transforms をカスタマイズして、さらに変換を追加します。"
    ...
    new "クリックして設定し、右クリックして後ろのリストに追加します。"
    ...
    new "表示されていないダイアログを通して次の選択肢にスキップしてもよろしいですか?"

    # renpy/common/00gui.rpy:459
    old "This save was created on a different device. Maliciously constructed save files can harm your computer. Do you trust this save's creator and everyone who could have changed the file?"
    new "このセーブファイルは別のデバイスで作成されました。悪意を持って作成されたセーブファイルはコンピュータに損害を与える可能性があります。このセーブファイルの作成者と、ファイルを変更した可能性のあるすべての人物を信頼できますか？"

    # renpy/common/00gui.rpy:460
    old "Do you trust the device the save was created on? You should only choose yes if you are the device's sole user."
    new "保存が作成されたデバイスを信頼しますか? デバイスの唯一のユーザーである場合のみ、「はい」を選択してください。"

    # renpy/common/00keymap.rpy:325
    old "Failed to save screenshot as %s."
    new "スクリーンショットを %s として保存できませんでした。"

    # renpy/common/00keymap.rpy:346
    old "Saved screenshot as %s."
    new "スクリーンショットを %s として保存しました。"
    ...
    new "このプログラムには、MITライセンスやGNU Lesser General Public Licenseなど、複数のライセンスに基づくフリーソフトウェアが含まれています。ソフトウェアの完全なリスト（完全なソースコードへのリンクを含む）は、{a=https://www.renpy.org/l/license}こちら{/a}でご覧いただけます。"
########
